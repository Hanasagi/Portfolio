...
export default {
  ...
  mounted() {
    ...
    setTimeout(()=>{
      ...
      el.classList.remove("root-container-clip-path");
      el.classList.add("root-visible-container-clip-path");
    })
      this.$refs.switch_button.classList.remove("root-container-clip-path");
      this.$refs.switch_button.classList.add("root-visible-container-clip-path");
    },500)
